...
\ans{
    Using L0 regularization we obtained a training error of \textbf{0.000} and a validation error of \textbf{0.028}.
    ...
    This is because the model does feature selection considering just \textbf{25} out of \textbf{101}, so by doing this 
