...
\newcommand{\centerfig}[3]{\begin{center}\includegraphics[width=#1\textwidth]{#2}\captionof{figure}{#3}\end{center}}
...
%JATJ: check this
\ans{
    The \texttt{DecisionStumpErrorRate} predict $y$ with an error of \fbox{0.253}. The following figure
    represents the boundary regions from the model.
}

\centerfig{0.7}{../figs/q6_2_decisionBoundary}{Boundary regions of \texttt{DecisionStumpErrorRate}}

See \hyperref[appendix:DecisionStumpErrorRate]{\textbf{Appendix A}} for the implementation of \texttt{DecisionStumpErrorRate}.\\
...
%JATJ: check this
\ans{
    The \texttt{DecisionStumpInfoGain} predict $y$ with an error of \fbox{0.325}. The following figure
    represents the boundary regions from the model.
}
\centerfig{0.7}{../figs/q6_3_decisionBoundary}{Boundary regions of \texttt{DecisionStumpInfoGain}}
\ans{
...
\begin{figure}[htp]
    \begin{subfigure}[b]{0.4\textwidth}
        \centerfig{1}{../figs/q6_4_decisionBoundary}{DecisionStumpInfoGain of depth 2}
      \label{fig:1}
    \end{subfigure}
    %
    \begin{subfigure}[b]{0.4\textwidth}
        \centerfig{1}{../figs/q6_4_1_HardCodedDecisionBoundary}{DecisionStumpHardCoded}
      \label{fig:2}
    \end{subfigure}
\end{figure}
\ans{
...
See \hyperref[appendix:DecisionStumpHardCoded]{\textbf{Apendix C}}, for de implementation of the \texttt{DecisionStumpHardCoded} classifier
...
\ans{
    ...
    \\ \\
    The model with the lowest training error would be the DecisionStumpInfoGain and the DecisionTreeClassifier from \emph{scikit-learn}. 
    The following figure is the classification boundary plot of that model. \\
}
\centerfig{1}{../figs/q6_5_1_LowestErrorDecisionBoundary}{Boundary regions of DecisionStumpInfoGain}
\centerfig{1}{../figs/q6_5_tree_errors}{Error over Depth of each classifier}
...
\begin{center}
    \lstinputlisting[firstline=81,lastline=151]{../code/decision_stump.py}
\end{center}

\section{Appendix: Decision Tree Info Gain}
\label{appendix:DecisionStumpInfoGain}
\begin{center}
    \lstinputlisting[firstline=170,lastline=237]{../code/decision_stump.py}
\end{center}

\section{Appendix: Simple Decision Tree}
\label{appendix:DecisionStumpHardCoded}
\begin{center}
    \lstinputlisting[firstline=9,lastline=43]{../code/simple_decision.py}
\end{center}
