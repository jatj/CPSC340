...
% JATJ: complete
\ans{
   The training error starts to reach 0 (Overfitting), but the testing error doesn't pass the $0.05\%$ error.
}
...
\begin{figure}[htp]
   \begin{subfigure}[b]{0.5\textwidth} \color{ans}
       \centerfig{1}{../figs/q1_2_training_validation_1}{$1st$ half as training set and $2nd$ as validation}
     \label{fig:1}
   \end{subfigure}
   %
   \begin{subfigure}[b]{0.5\textwidth} \color{ans}
       \centerfig{1}{../figs/q1_2_training_validation_2}{$2nd$ half as training set and $1st$ as validation}
     \label{fig:2}
   \end{subfigure}
\end{figure}
\clearpage
...
% JATJ: listings naive_bayes fit, explain
\ans{
